...
void showCustomCountryPicker({
  ...
  showCustomCountryListBottomSheet(
    context: context,
    onSelect: onSelect,
    onClosed: onClosed,
    exclude: exclude,
    ...
    countryListTheme: CountryListThemeData(
      ...
      searchTextStyle: commonPrimaryTextStyle(),
      inputDecoration: InputDecoration(
        labelStyle: commonSecondaryTextStyle(),
        labelText: locale.value.searchHere,
        prefixIcon: IconWidget(imgPath: Assets.iconsMagnifyingGlass, size: 16).paddingAll(16),
        border: const OutlineInputBorder(borderSide: BorderSide(color: borderColor)),
        focusedBorder: const OutlineInputBorder(borderSide: BorderSide(color: primaryTextColor)),
      ),
    ),
