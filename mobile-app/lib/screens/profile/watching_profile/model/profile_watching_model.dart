...
class WatchingProfileModel {
  ...
  bool get isProfileProtected => profilePin.isNotEmpty && isProtectedProfile.getBoolInt();
  ...
  factory WatchingProfileModel.fromJson(Map<String, dynamic> json) {
    return WatchingProfileModel(
      ...
      isChildProfile: json['is_child_profile'] is int ? json['is_child_profile'] : 0,
