...
@section('content')
    ...
    {{ html()->form('POST', route('backend.faqs.update', $data->id))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->attribute('id', 'form-submit')->class('requires-validation')->attribute('novalidate', 'novalidate')->open() }}
    @csrf
    @method('PUT')
        ...
        <div class="card-body">
            <div class="row gy-3">
                ...
                <div class="col-md-6">
                    ...
                    {{ html()->text('question')->attribute('value', $data->question)->placeholder(__('faq.enter_question'))->class('form-control')->required() }}
                    @error('question')
                ...
                <!-- Answer Field -->
                <div class="col-md-6">
                    <label for="answer" class="form-label">{{ __('faq.lbl_answer') }} <span
