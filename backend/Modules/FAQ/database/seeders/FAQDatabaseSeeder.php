...
class FAQDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('faqs')->insert(array (
            ...
            array (
                'id' => 1,
                'question' => '1. What is ApexPrime Tv Laravel?',
                'answer' => 'ApexPrime Tv Laravel is a cutting-edge streaming platform developed by Varchaswaa Design that allows users to watch movies, TV shows, and live content seamlessly. It provides a feature-rich experience with personalized recommendations, multiple subscription plans, and high-quality streaming.',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
            ...
            array (
                'id' => 2,
                'question' => '2. How can I create an account on ApexPrime Tv Laravel?',
...
You can choose your preferred method at checkout.',
            ...
            array (
                ...
                'answer' => 'Yes, ApexPrime Tv Laravel allows you to download selected content for offline viewing, depending on your subscription plan. This feature is available for both mobile and tablet devices.',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
            ...
            array (
                'id' => 8,
                'question' => '8. Does ApexPrime Tv Laravel support multiple devices?',
            ...
            array (
                ...
                'answer' => 'Our referral program rewards you for inviting friends to join ApexPrime Tv Laravel. For each friend who subscribes using your referral link, you both receive a discount on your next billing cycle. Check the referral section in your account for more details!',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
            ...
            array (
                'id' => 12,
                'question' => '12. What types of content are available on ApexPrime Tv Laravel?',
                'answer' => 'ApexPrime Tv Laravel offers a diverse range of content, including movies, TV shows, documentaries, and live events across various genres. You\'ll find everything from action and comedy to horror and romance!',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
            ...
            array (
                'id' => 15,
                'question' => '15. Is there any age restriction for using ApexPrime Tv Laravel?',
            ...
            array (
                'id' => 18,
                'question' => '18. Does ApexPrime Tv Laravel offer subtitles or closed captions?',
            ...
            array (
                'id' => 20,
                'question' => '20. How do I use the parental controls on ApexPrime Tv?',
                'answer' => 'To use parental controls on ApexPrime Tv, navigate to your account settings. Here, you can set age restrictions for various content types and block specific shows or movies. Additionally, you can create custom profiles for family members with tailored controls. For added security, consider setting a PIN or password.',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
            ...
            array (
                ...
                'answer' => 'To enable subtitles or closed captions while watching content on ApexPrime Tv, look for the "Subtitles" or "CC" icon on the video player. Click on it, and you can choose your preferred language for subtitles. This feature enhances your viewing experience and accessibility.',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
            ...
            array (
                'id' => 22,
                'question' => '22. How do I customize my ApexPrime Tv homepage?',
                'answer' => 'To customize your ApexPrime Tv homepage, log into your account and navigate to the "Settings" section. From there, you can personalize your homepage by selecting your favorite genres, organizing your watchlist, and adjusting display preferences to see content that interests you most.',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
            ...
            array (
                ...
                'answer' => 'To download videos for offline viewing on ApexPrime Tv, find the desired movie or show and look for the download icon. Click it, and the content will be saved to your device for offline access. Note that the ability to download may depend on your subscription plan.',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
            ...
            array (
                ...
                'answer' => 'If you need assistance, you can reach our customer support team via email at hello@varchaswaa.design. We\'re here to help!',
                'status' => 1,
                'created_by' => 2,
                'updated_by' => 2,
                'deleted_by' => NULL,
