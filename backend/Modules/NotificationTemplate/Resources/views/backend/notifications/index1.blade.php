                        ...
                        @forelse($$module_name as $module_name_singular)
                            ...
                            <tr class="{{ $row_class }}">
                                @if ($module_name_singular->data['data']['notification_type'] == 'new_subscription')
                                    <td>
                                        <span
                                            class="{{ $span_class }}">{{ ucfirst($module_name_singular->data['data']['id']) }}</span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3 align-items-center">
                                            <div class="text-start">
                                                ...
                                                <span
                                                    class="font-weight-bold">{{ $notification->notification_message }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3 align-items-center">
                                            <img src="{{ setBaseUrlWithFileName($user->file_url, 'image', 'users') ?? default_user_avatar() }}"
                                ...
                                @else
                                    ...
                                    <td>
                                        <span
                                            class="{{ $span_class }}">{{ ucwords(str_replace('_', ' ', $module_name_singular->data['data']['notification_group'])) }}</span>
                                    </td>
                                        ...
                                        <div class="d-flex gap-3 align-items-center">
                                            <div class="text-start">
                                                ...
                                                <span class="font-weight-bold"> Your
                                                    {{ $module_name_singular->data['data']['service_name'] }} account
                                                    balance is insufficient. Please recharge your account to maintain
                                    ...
                                    <td>
                                        <div class="d-flex gap-3 align-items-center">
                                            ...
                                            <div class="text-start">
                                                <h6 class="m-0">{{ $module_name_singular->data['data']['user_name'] }}
                                                </h6>
                                            </div>
                                        </div>
                                    </td>
