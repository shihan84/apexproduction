...
{
    /**
     * Run the migrations - Recreate Music and Shorts tables with global standard schemas
     */
    public function up(): void
    {
        ...
        // Create music_tracks table with global standard schema
        ...
        // Create shorts table with global standard schema
        Schema::create('shorts', function (Blueprint $table) {
            ...
            $table->foreignId('category_id')->nullable()->constrained('shorts_categories')->cascadeOnDelete();
            $table->json('tags')->nullable();
