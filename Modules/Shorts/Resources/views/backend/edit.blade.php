...
@section('title', __('sidebar.edit_short'))
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('sidebar.edit_short') }}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('sidebar.edit') }}</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('sidebar.edit_short') }}</h3>
                    ...
                    <form action="{{ route('backend.shorts.update', $short->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            @if ($errors->any())
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                               id="title" name="title" value="{{ old('title', $short->title) }}" required>
                                        @error('title')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                                               id="slug" name="slug" value="{{ old('slug', $short->slug) }}">
                                        @error('slug')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  id="description" name="description" rows="3">{{ old('description', $short->description) }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <select class="form-control @error('category_id') is-invalid @enderror" 
                                            ...
                                            @foreach($categories as $category)
                                                <option value="{{ $category->id }}" 
                                                        {{ old('category_id', $short->category_id) == $category->id ? 'selected' : '' }}>
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('content_type') is-invalid @enderror" 
                                            ...
                                            <option value="upload" {{ old('content_type', $short->content_type) == 'upload' ? 'selected' : '' }}>
                                                {{ __('common.upload') }}
                                            </option>
                                            <option value="youtube" {{ old('content_type', $short->content_type) == 'youtube' ? 'selected' : '' }}>
                                                {{ __('common.youtube') }}
                                            </option>
                                            <option value="external" {{ old('content_type', $short->content_type) == 'external' ? 'selected' : '' }}>
                                                {{ __('common.external') }}
                                            </option>
                                        </select>
                                        @error('content_type')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" 
                                            ...
                                            <option value="1" {{ old('status', $short->status) == 1 ? 'selected' : '' }}>
                                                {{ __('common.active') }}
                                            </option>
                                            <option value="0" {{ old('status', $short->status) == 0 ? 'selected' : '' }}>
                                                {{ __('common.inactive') }}
                                            </option>
                                        </select>
                                        @error('status')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('video_url') is-invalid @enderror" 
                                               id="video_url" name="video_url" value="{{ old('video_url', $short->video_url) }}" required>
                                        @error('video_url')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('thumbnail_url') is-invalid @enderror" 
                                               id="thumbnail_url" name="thumbnail_url" value="{{ old('thumbnail_url', $short->thumbnail_url) }}">
                                        @error('thumbnail_url')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('duration') is-invalid @enderror" 
                                               id="duration" name="duration" value="{{ old('duration', $short->duration) }}" min="0">
                                        @error('duration')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('width') is-invalid @enderror" 
                                               id="width" name="width" value="{{ old('width', $short->width) }}" min="0">
                                        @error('width')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('height') is-invalid @enderror" 
                                               id="height" name="height" value="{{ old('height', $short->height) }}" min="0">
                                        @error('height')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input @error('allow_comments') is-invalid @enderror" 
                                                   ...
                                                   {{ old('allow_comments', $short->allow_comments) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input @error('allow_download') is-invalid @enderror" 
                                                   ...
                                                   {{ old('allow_download', $short->allow_download) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('tags') is-invalid @enderror" 
                                               id="tags" name="tags" value="{{ old('tags', is_string($short->tags) ? json_decode($short->tags) : $short->tags) ? implode(',', is_string($short->tags) ? json_decode($short->tags) : $short->tags) : '' }}" 
