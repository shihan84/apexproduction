            ...
            <div class="card">
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div id="download_quality_status_section"
                            class="col-md-12 download_quality_status_section {{ old('enable_download_quality', $data->enable_download_quality ?? 0) == 1 ? '' : 'd-none' }}">
                            <div id="video-inputs-container-parent">
                                @if (!empty($data->videoDownloadMappings) && count($data->videoDownloadMappings) > 0)
                                    ...
                                    @endforeach
                                @else
                                    <div class="row video-inputs-container mt-1">
                                        <div class="col-md-6 col-lg-4">
                                            {{ html()->label(__('movie.lbl_quality_video_download_type'), 'quality_video_download_type')->class('form-label') }}
                                            {{ html()->select(
                                                    'quality_video_download_type[]',
    ...
    @push('after-scripts')
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#download_type, #video_download_quality').select2({
                    width: '100%'
                });
