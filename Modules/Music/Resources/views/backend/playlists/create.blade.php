...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1 class="m-0">Create Playlist</h1></div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('backend.music.playlists.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Add Tracks <small class="text-muted">(Hold Ctrl/Cmd to select multiple)</small></label>
                                        <select name="track_ids[]" class="form-control" multiple size="8">
                                            @foreach($tracks as $track)
                                                <option value="{{ $track->id }}">{{ $track->title }} — {{ $track->artist_name }} ({{ $track->genre ?? 'Unknown' }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="is_public" name="is_public" value="1" {{ old('is_public', 1) ? 'checked' : '' }}>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i> Create Playlist</button>
